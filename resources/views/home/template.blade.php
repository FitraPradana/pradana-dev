<section id="template" class="portfolio">
    <div class="container" data-aos="fade-up">
        ...
        <ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <li data-filter=".filter-profile">Company Profile</li>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-profile">
                <div class="portfolio-img"><img
                        src="{{ asset('/') }}source_Arsha/assets/img/template/WEB_courier-v1.0.0/1. Home.png"
                        class="img-fluid" alt=""></div>
                <div class="portfolio-info">
                    <h4>Home</h4>
                    <p>Web Courier</p>
                    <a href="{{ asset('/') }}source_Arsha/assets/img/template/WEB_courier-v1.0.0/1. Home.png"
                        data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Home"><i
                            class="bx bx-plus"></i></a>
                    <a href="{{ asset('/') }}source_Arsha/assets/img/template/WEB_courier-v1.0.0/2. Our Services.png"
                        data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"
                        title="Our Services"></a>
                    <a href="{{ asset('/') }}source_Arsha/assets/img/template/WEB_courier-v1.0.0/4. Testimonial.png"
                        data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Testimonial"></a>
                    <a href="{{ asset('/') }}source_Arsha/assets/img/template/WEB_courier-v1.0.0/5. Contact Us.png"
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-profile">
                <div class="portfolio-img"><img
                        src="{{ asset('/') }}source_Arsha/assets/img/template/WEB_finance-business-1.0.0/1. Home.png"
                        class="img-fluid" alt=""></div>
                <div class="portfolio-info">
                    <h4>Home</h4>
                    <p>Web Finance and Business</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-project">
                ...
                <div class="portfolio-info">
                    <h4>Login</h4>
                    <p>Web E-Commerce Penjualan</p>
                    <a href="{{ asset('/') }}source_Arsha/assets/img/template/Project E-Commerce Dream Pos/Login.png"
                        data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Login"><i
                            class="bx bx-plus"></i></a>
                    <a href="{{ asset('/') }}source_Arsha/assets/img/template/Project E-Commerce Dream Pos/Dashboard.png"
                        data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"
                        title="Dashboard"></a>
